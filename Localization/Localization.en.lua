...
core.L = {
  ...
  MINUTE = "minute",
  MINUTES = "minutes",
  MONDKPSCALESIZE = "EssentialDKP Scale Size",
  MONDKPSCALESIZETTDESC = "Scale of the EssentialDKP window. Click \"Save Settings\" to change size to set value.",
  ...
  OUTOFDATEANNOUNCE = "Your version of EssentialDKP is out-of-date. Please update to ensure there are no compatibility issues.",
  ...
  CHANGELOG1 = "New sync option added: /dkp sync that allows import-export with a string like weakauras. Makes game freeze for a bit. Use at your own risk :)",
  CHANGELOG2 = "DKP Merge issue related fix to hitting history limit occuring for Officers only",
  CHANGELOG3 = "Suppressing some of !dkp whispers",
  CHANGELOG4 = "Fix for timer communication",
  CHANGELOG5 = "",
